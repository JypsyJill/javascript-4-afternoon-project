...
/*
 Below we have the constructor Animal.  The eat method is using the "this" keyword.  Use the "new" keyword to assign context to "this", and
  save the instance to a variable named animal1.  You can pass anything you want in for name, species and food.
*/
...
var animal1 = new Animal('Max', 'doggo', 'everything he can')
////////// PROBLEM 3 //////////

/*
  Use the bind method to assign context of the "this" keyword in the sayHi function to the user object; and save the bound function to a
   variable named whoSaysHi.  
*/
